...
const Home = () => {
    ...
    return (
        <>
            <div id="Info" className={`bg-white d-none text-dark mt-5 w-50 m-auto px-5 py-3 ${Stsyels.info}`} >
            <div className={`d-flex justify-content-between  list-unstyled ${Stsyels.info2}`} >
              <div>
            ...
            <div className='home-page bg-white'>
                ...
                <div className='banner container-sm px-4'>
                    <div className='banner-content row row-cols-1 row-cols-md-2 row-cols-lg-3'>
                        ...
                        bannerProducts.map((p,i) => {
                            return (
                                <div key={p.i} className="product p-0 position-relative" style={{Height:"350px"}}>
                                    <img src={`${p.imageURL}`} alt="" className='h-100 w-100' />
                                    <div className='content position-absolute'>
                                        <h3 className='name fs-5 m-2 position-absolute top-0 start-0' style={{height:"50px"}}>
                                        ...
                                        <div className='after-disc position-absolute bottom-0 end-0'> 
                                            <span className='after-disc ps-2'>{`$${(p.price * 0.75).toFixed(2)}`}</span>
                                        </div>
                                        <div className='price position-absolute'> 
                                            <span className='before-disc ps-2'> {`$${p.price}`} </span>
                ...
                <div className="best-seller container-sm my-3">
                    <h2 className='text-center text-uppercase fw-bold my-3'>Best seller</h2>
                                ...
                                <div key={p.id} className="product col d-flex flex-column">
                                    <div className='product-content border border-1 rounded-2'>
                                        <div className='image d-flex position-relative'>
                                            <img style={{height:"300px"}} src={`${p.imageURL}`} alt="" className='w-100' />
                                            <div className='cart-favorite-info bg-white rounded-2 position-absolute justify-content-center align-items-center gap-2'>
                                                <button className='heart rounded-circle p-2'>
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#33A0FF" className="bi bi-heart" viewBox="0 0 16 16">
                                                        <path d="m8 2.748-.717-.737C5.6.281 2.514.878 1.4 3.053c-.523 1.023-.641 2.5.314 4.385.92 1.815 2.834 3.989 6.286 6.357 3.452-2.368 5.365-4.542 6.286-6.357.955-1.886.838-3.362.314-4.385C13.486.878 10.4.28 8.717 2.01L8 2.748zM8 15C-7.333 4.868 3.279-3.04 7.824 1.143c.06.055.119.112.176.171a3.12 3.12 0 0 1 .176-.17C12.72-3.042 23.333 4.867 8 15z"/>
                                                    </svg>
                                                </button>
                                                <button className='cart rounded-circle p-2' onClick={() => addProduct(p)}>
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#33A0FF" className="bi bi-cart3" viewBox="0 0 16 16">
                                        ...
                                        <div className='info text-center m-2'>
                                            ...
                                            <div className='rate d-flex justify-content-center gap-1 mb-2' title={`${p.rating.rate}`}>
                                            {
                                                [...Array(Math.floor(p.rating.rate))].map((_,i) => {
                                                    return(
                                                        <svg key={`${p.id}-${i}`} xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="gold" className="bi bi-star-fill" viewBox="0 0 16 16">
                                            ...
                                            }
                                            {
                                                [...Array(1)].map((_,i) => {
                                                    ...
                                                    if(subStar !== 0 ) {
                                                        return (
                                                            <svg key={`${p.id}-${i}`} xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill={`url(#grad-${p.id})`} className="bi bi-star-fill" viewBox="0 0 16 16">
                                                                <defs>
                                                                    <linearGradient id={`grad-${p.id}`} x1="0%" y1="0%" x2="100%" y2="0%">
                                                                        <stop offset="0%" stopColor="gold" stopOpacity="1" />
                                                                        <stop offset={`${subStar*100}%`} stopColor="gold" stopOpacity="1" />
                                                                        <stop offset={`${subStar*100}%`} stopColor="#c1c8ce" stopOpacity="1" />
                                                                        <stop offset="100%" stopColor="#c1c8ce" stopOpacity="1" />
                ...
                <div className='why-us py-5 '>
                    <h2 className='text-center p-3' style={{color:"#22262A"}}> WHY US </h2>
                ...
                <div className='latest-news'>
                    <h2 className='text-center p-3' style={{color:"#22262A"}}> LATEST NEWS </h2>
                ...
                <div className='featured-products'>
                    <h2 className='text-center p-3' style={{color:"#22262A"}}> FEATURED PRODUCTS </h2>
                                ...
                                return(
                                    <div key={p.id} className="product p-2 p-lg-4">
                                        <div className='product-content d-flex border border-1 rounded-2'>
                                            <div className='image d-flex position-relative'>
                                                <img style={{height:"150px",width:"150px"}} src={`${p.imageURL}`} alt="" />
                                                <div className='cart-favorite-info bg-white rounded-2 position-absolute justify-content-center align-items-center gap-2'>
                                                    <button className='heart rounded-circle p-2'>
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#33A0FF" className="bi bi-heart" viewBox="0 0 16 16">
                                                            <path d="m8 2.748-.717-.737C5.6.281 2.514.878 1.4 3.053c-.523 1.023-.641 2.5.314 4.385.92 1.815 2.834 3.989 6.286 6.357 3.452-2.368 5.365-4.542 6.286-6.357.955-1.886.838-3.362.314-4.385C13.486.878 10.4.28 8.717 2.01L8 2.748zM8 15C-7.333 4.868 3.279-3.04 7.824 1.143c.06.055.119.112.176.171a3.12 3.12 0 0 1 .176-.17C12.72-3.042 23.333 4.867 8 15z"/>
                                            ...
                                            <div className='info d-flex gap-2 flex-column'>
                                                ...
                                                <div className='rate d-flex gap-1 m-2' title={`${p.rating.rate}`}>
                                                {
                                                ...
                                                }
                                                {
                                                    [...Array(1)].map(() => {
                                                        ...
                                                        if(subStar !== 0 ) {
                                                            return (
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill={`url(#grad-${p.id})`} className="bi bi-star-fill" viewBox="0 0 16 16">
                                                                    <defs>
                                                                        <linearGradient id={`grad-${p.id}`} x1="0%" y1="0%" x2="100%" y2="0%">
                                                                            <stop offset="0%" stopColor="gold" stopOpacity="1" />
                                                                            <stop offset={`${subStar*100}%`} stopColor="gold" stopOpacity="1" />
                ...
                <div className="container-sm py-5 d-flex justify-content-center">
                    <div className='search'>
                        <input className='p-2' type="search" placeholder='Search query...' />
