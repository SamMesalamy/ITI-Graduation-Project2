            ...
            <div className={`card shadow-lg p-3 mb-5 bg-white rounded ${styles2.main_card}`}>
              <div className={styles2.product_img_container}>
                ...
                <div className="card-body text-start">
                  ...
                  <Link to={`/ProductDetails/${product.id}`} className={styles2.name}><h5 className={`card-title ${styles2.name}`} >{product.name}</h5></Link>
                  <h3 className="card-title">{product.brand}</h3>
                  <h3 className={`card-title ${styles2.realprice}`}>{product.price}$</h3>
                  <h3 className={`card-title text-decoration-line-through ${styles2.price}`}>
